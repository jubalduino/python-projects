# Olá, eu sou a Julianna Balduino de Oliveira! 👋
...
- 🐾 **Curiosidade:** Quando não estou codando ou desenhando experiências, provavelmente estou pedalando por São Paulo ou cuidando do Kai Marx, meu companheiro de quatro patas.
...
Aqui estão algumas das soluções que desenvolvi unindo código, arte e psicologia:

#### 🎮 Crianças Forrozeiras
*Aplicativo mobile interativo focado na salvaguarda e ensino da cultura do Nordeste brasileiro para crianças.*
- **Tecnologias:** Python + Flet.
- **O que apliquei:** UX adaptada ao público infantil, gamificação e design centrado na experiência de aprendizagem.


#### 🏛️ Patrimônios da Independência
*Projeto de Realidade Aumentada (AR) para dispositivos móveis que dá vida a edifícios históricos e personagens do Brasil.*
- **Tecnologias:** Integração de ferramentas de AR e design de interface.
- **O que apliquei:** Neurodesign aplicado ao reconhecimento espacial e resgate histórico-cultural interativo.
...
Estou sempre aberta a conexões, trocas de experiências sobre transição de carreira, tecnologia na educação e design!
![Python](https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54)

- **LinkedIn:** [Acesse meu perfil profissional](https://linkedin.com/in/julianna-balduino)
- **E-mail:** [Email](mailto: balduinooju@gmail.com.com)
- **Localização:** São Paulo, SP 📍

---

<p align="center">
  <i>"Transformando linhas de código em pontes para o conhecimento ."</i>
</p>
